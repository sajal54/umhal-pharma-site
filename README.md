...
<body class="bg-gradient-to-br from-white via-blue-50 to-emerald-100 min-h-screen">
  ...
  <section class="mt-8 p-4 bg-white rounded-2xl shadow-md max-w-3xl mx-auto">
  ...
  <section class="mt-16 p-4 max-w-xl mx-auto bg-white rounded-2xl shadow-md">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="bg-white rounded-2xl shadow-md p-4 text-center">
        ...
        <p class="text-sm text-gray-600">Director</p>
        <p class="text-gray-700 mt-2">Phone: <a href="tel:9993037545" class="text-emerald-700 hover:underline">9993037545</a></p>
      </div>
    </div>
  </section>

  <section class="mt-16 p-4">
    <h2 class="text-2xl font-semibold text-blue-700 mb-6">Our Products</h2>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">VetHeal Spray</h3>
        <p class="text-sm text-gray-600">Wound Relief Spray for rapid healing and infection prevention.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M8 12l2 2 4-4"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">Utrica Suspension</h3>
        <p class="text-sm text-gray-600">Effective solution for placenta removal in livestock.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect width="20" height="14" x="2" y="5" rx="2"/><path d="M2 7h20"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">Calcitrol Plus</h3>
        <p class="text-sm text-gray-600">Calcium supplement to ensure healthy bone growth in animals.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm0 0v10l6 3"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">Scobie Natural Soap</h3>
        <p class="text-sm text-gray-600">Gentle, natural soap for animal hygiene and skin care.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M3 12h18M3 6h18M3 18h18"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">Vetrol Powder</h3>
        <p class="text-sm text-gray-600">Anti-diarrhoeal powder for effective digestive support in animals.</p>
      </div>
      <div class="bg-white rounded-2xl shadow-md p-4 hover:scale-105 hover:shadow-xl transition-transform duration-200 flex flex-col items-center">
        <svg class="w-12 h-12 text-blue-700 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M8 12l2 2 4-4"/></svg>
        <h3 class="text-lg font-bold text-emerald-800">Maltzilla</h3>
        <p class="text-sm text-gray-600">Nutritious malt-based supplement for overall animal wellness.</p>
      </div>
    </div>
  </section>
